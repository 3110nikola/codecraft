...
export default function GenerateLeads() {
  return (
    <div>
      ...
      <Navbar />
      <Banner
        heading="The Formula to Increase Sales Qualified Leads on Your Enterprise Website"
        image={formula}
      />
      <div className="flex flex-col-reverse md:flex-row gap-10 px-5 py-20 max-w-5xl mx-auto">
        <BlogSocial title="The Formula to Increase Sales Qualified Leads on Your Enterprise Website" />
        <div className="flex flex-col gap-5">
          ...
          <ul className="list-decimal marker:text-yellow-400 ml-5">
          ...
          <ul className="ml-5 text-yellow-400 list-disc">
